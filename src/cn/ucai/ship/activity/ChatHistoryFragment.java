...
import cn.ucai.ship.adapter.ChatHistoryAdapter;
...
public class ChatHistoryFragment extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		final String st = getResources().getString(cn.ucai.ship.R.string.Cant_chat_with_yourself);
		listView.setOnItemClickListener(new OnItemClickListener() {

			@Override
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				EMContact emContact = adapter.getItem(position);
				if (adapter.getItem(position).getUsername().equals(ShipApplication.getInstance().getUserName()))
	 ...
	 */
	public void refresh() {
		adapter = new ChatHistoryAdapter(getActivity(), cn.ucai.ship.R.layout.row_chat_history, loadUsersWithRecentChat());
		listView.setAdapter(adapter);
		adapter.notifyDataSetChanged();
	}
