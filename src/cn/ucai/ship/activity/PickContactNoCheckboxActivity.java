...
public class PickContactNoCheckboxActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.ship.R.layout.activity_pick_contact_no_checkbox);
		listView = (ListView) findViewById(cn.ucai.ship.R.id.list);
		sidebar = (Sidebar) findViewById(cn.ucai.ship.R.id.sidebar);
		sidebar.setListView(listView);
		contactList = new ArrayList<User>();
		// 获取设置contactlist
		getContactList();
		// 设置adapter
		contactAdapter = new ContactAdapter(this, cn.ucai.ship.R.layout.row_contact, contactList);
